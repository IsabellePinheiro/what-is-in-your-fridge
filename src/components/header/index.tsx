  ...
  return(
    <header className="flex py-4 px-8 flex-row justify-between">
      <div className="flex  justify-center items-center">
        <Image quality={100} width={50} height={50} src={logo} alt='Logo' className="mr-6"/>
        <h1 className="text-ignite-500 text-3xl font-bold leading-tight">WHAT'S IN YOUR FRIDGE?</h1>
      </div>
